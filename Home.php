         ...
         <?php    
            ...
            //echo $city_data;
             ...
             if(isset($_POST['search'])){
                $sql="select image from property_images,properties where loc_id='$city_data' and location_id=loc_id and image like 'h_i%';";
                }
                else{
                    $sql="select image from property_images,properties where loc_id='d' and location_id=loc_id and image like 'h_i%';";
                     }
            ...
            if($res->num_rows)
            {
               ...
               echo 
               '<div class="col-md-5 d-inline-block ml-5">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 float-right">
                            ...
                            <a href="#" class="btn btn-primary mt-4">See Profile</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row ml-5 mt-2">
        ...
        <div class="col-lg-3 col-sm-12">
            <div class="card-deck mt-4 mb-4">
                <div class="card">
                    <img class="card-img-top" src="images/img20.jpg" alt="Card image" style="width:100%">
                    <div class="card-body">
                        <h4 class="card-title"><b>Himalaya Pride</b></h4>
                        <p class="card-text">Himalaya Group</p>
                        <p class="card-text">2,3,4 BHK Flats</p>
                        <p class="card-text">Rs.<b>40 Lac </b><small class="text-danger">onwards</small></p>
        ...
        <div class="col-lg-3 col-sm-12">
            <div class="card-deck mt-4 mb-4">
                <div class="card">
                    <img class="card-img-top" src="images/img21.jpg" alt="Card image" style="width:100%">
                    <div class="card-body">
                        <h4 class="card-title"><b>Galaxy Enclave</b></h4>
                        <p class="card-text">Galaxy Group</p>
                        <p class="card-text">Residential Plots & 3 BHK Villas</p>
                        <p class="card-text">Rs.<b>17.9 Lac </b><small class="text-danger">onwards</small></p>
        ...
        <div class="col-lg-3 col-sm-12">
            <div class="card-deck mt-4 mb-4">
                <div class="card">
                    <img class="card-img-top" src="images/img22.jpg" alt="Card image" style="width:100%">
                    <div class="card-body">
                        <h4 class="card-title"><b>T Homes</b></h4>
                        <p class="card-text">T & T Group</p>
                        <p class="card-text">3,4 BHK Flats</p>
                        <p class="card-text">Rs.<b>56.7 Lac </b><small class="text-danger">onwards</small></p>
